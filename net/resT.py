...
class Upsample_(nn.Module):
    def __init__(self, scale=2):
        ...
        self.upsample1 = nn.ConvTranspose2d(768, 512, kernel_size=4, stride=2, padding=1)
        ...
        # self.upsample5 = nn.Upsample(mode="bilinear", scale_factor=scale)
...
class ResTV2(nn.Module):
    ...
    def init_weights(self):
        if self.pretrained is None:
            ...
            logger = logging.getLogger()
            ckpt = load_checkpoint(self.pretrained, logger=logger, map_location='cpu')
